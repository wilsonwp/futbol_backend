		...
		<thead>
			...
			<th>Equipo visitante</th>
				...
				<td>{{$partido->campeonato->nombre_campeonato}}</td>
                                ...
                                <td>@if($partido->estatus_partido == 0)@endif  @if($partido->estatus_partido == 1)<button value="{{$partido->id}}" OnClick="mostrar(this);" class='btn btn-primary' data-toggle="modal" data-target="#myModal2">Minuto a Minuto</button> @endif @if($partido->estatus_partido == 2) <button value="{{$partido->id}}" OnClick="mostrar3(this);" class='btn btn-primary' data-toggle="modal" data-target="#myModal3">Ver Estadisticas</button>  @endif </td>
